...
namespace ResearchandVehicle
{
	...
	public class ResearchandVehicleGSInstanceData
	{
	...
	/// </summary>
	public class ResearchandVehicleGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new ResearchandVehicleGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			ResearchandVehicleGSInstanceData data = (ResearchandVehicleGSInstanceData)instanceData;
		}
