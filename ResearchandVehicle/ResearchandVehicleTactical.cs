...
namespace ResearchandVehicle
{
	...
	public class ResearchandVehicleTacInstanceData
	{
	...
	/// </summary>
	public class ResearchandVehicleTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			ResearchandVehicleMain main = (ResearchandVehicleMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			ResearchandVehicleTacInstanceData data = (ResearchandVehicleTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new ResearchandVehicleTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
