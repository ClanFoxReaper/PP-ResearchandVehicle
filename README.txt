...
- ResearchandVehicleConfig.cs: Example of ModConfig for custom mod settings;
- ResearchandVehicleGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ResearchandVehicleMain.cs: Main mod class, recieves mod management and general events;
- ResearchandVehicleTactical.cs: Example of ModTactical for modifying tactical level;
